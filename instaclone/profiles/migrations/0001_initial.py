# Generated by Django 4.1.13 on 2025-03-29 16:56
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('profile_status', models.CharField(choices=[('Open Profile', 'Open Profile'), ('Private Profile', 'Private Profile')], default='Open Profile', max_length=25)),
